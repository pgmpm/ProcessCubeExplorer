...
{
    [TestClass]
    public class ComparingFootprintsFitnessTests
    {
        /// <summary>
        /// Test for the right result of the fitness from an eventlog and a petrinet
        /// </summary>
        ...
        /// </summary>
        /// <autor>Naby Sow</autor>
        [TestMethod]
        [ExpectedException(typeof(Exception))]
        public void CalculateFitnessExceptionTest1()
        {       
                double result = ComparingFootprintAlgorithm.CalculateFitness(-10, -20);
                Assert.Fail();            
        }
    }
}